...
import com.zyao.zcore.anim.DefaultVerticalAnimator;
...
public abstract class SupportActivity extends AppCompatActivity implements ISupport
{
    ...
    {
        return new FragmentAnimator(mFragmentAnimator.getEnter(), mFragmentAnimator.getExit(), mFragmentAnimator.getPopEnter(), mFragmentAnimator.getPopExit());
    }
    ...
    public void onBackPressed ()
    {
        ...
        if (mFragmentation.dispatchBackPressedEvent(activeFragment))
        {
            return;
        }
