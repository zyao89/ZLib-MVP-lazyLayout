...
import com.zyao.zcore.helper.AnimatorHelper;
import com.zyao.zcore.helper.DebounceAnimListener;
...
public abstract class SupportFragment extends Fragment implements ISupportFragment
{
    ...
    public Animation onCreateAnimation (int transit, boolean enter, int nextAnim)
    {
        ...
        {
            if (enter)
            {    // 此处在设置SharedElement时,回调  transit=0, enter=true, nextAnim=0
                mEnterAnimFlag = true;
            }
    ...
    {
        TypedArray a = _mActivity.getTheme().obtainStyledAttributes(new int[]{android.R.attr.windowBackground});
