 ...
 * @author Zyao89
 */
public class UTForGBKUtil
{
    private static UTForGBKUtil mInstance = null;
    private final Context mContext;

    private UTForGBKUtil (Context context)
    {
        this.mContext = context;
    }

    static UTForGBKUtil with (Context context)
    {
        if (mInstance == null)
        {
            synchronized (UTForGBKUtil.class)
            {
                if (mInstance == null)
                {
                    mInstance = new UTForGBKUtil(context);
                }
            }
        }
        return mInstance;
     ...
     * @return String
     */
    public String Unicode2GBK (String dataStr)
    {
        int index = 0;
    ...
    public boolean isNeedConvert (char para)
    {
