package com.zyao.views.zloading.render.scenery;
...
public class ElectricFanLoadingRenderer extends LoadingRenderer
{
    ...
    protected void draw (Canvas canvas, Rect bounds)
    {
        ...
        mLoadingDrawable.setBounds((int) arcBounds.centerX() - mLoadingDrawable.getIntrinsicWidth() / 2, 0, (int) arcBounds.centerX() + mLoadingDrawable.getIntrinsicWidth() / 2, mLoadingDrawable.getIntrinsicHeight());
    ...
    private ValueAnimator getBezierValueAnimator (LeafHolder target, RectF leafFlyRect, float progress)
    {
        ...
        ValueAnimator animator = ValueAnimator.ofObject(evaluator, new PointF((int) (leafFlyRect.right - mLeafDrawable.getIntrinsicWidth()), startPointY), new PointF(leafFlyRect.left, endPointY));
