...
/**
 * Class: ZStickLoadingView
 * Description: TODO 功能描述...
 * Author: Zyao89
 * Time: 2016/9/18 17:20
 */
public class ZStickLoadingView extends View
{
    ...
    /** 大圆抖动动画时间 */
    private int mTranslateDuration = TRANSLATE_DEFAULT;
    /** 默认动画时间 */
    private static final int DURATION_DEFAULT = 1000;
    private static final int TRANSLATE_DEFAULT = 250;
    /** 绘制第一步 */
    ...
    /** 线条颜色 */
    private static int[] COLORS = new int[]{0xFF7ECBDA, 0xFFE6A92C, 0xFFF0A0A5, 0xFF5ABA94};

    public ZStickLoadingView (Context context)
    {
        this(context, null);
    }

    public ZStickLoadingView (Context context, AttributeSet attrs)
    {
        this(context, attrs, 0);
    }

    public ZStickLoadingView (Context context, AttributeSet attrs, int defStyleAttr)
    {
    ...
    {
        TypedArray ta = context.obtainStyledAttributes(attrs, R.styleable.stick_view);
        COLORS[0] = ta.getColor(R.styleable.stick_view_stick_loading_one_color, Color.WHITE);
        COLORS[1] = ta.getColor(R.styleable.stick_view_stick_loading_two_color, Color.WHITE);
        COLORS[2] = ta.getColor(R.styleable.stick_view_stick_loading_three_color, Color.WHITE);
        COLORS[3] = ta.getColor(R.styleable.stick_view_stick_loading_four_color, Color.WHITE);
        ta.recycle();
    ...
    private void initData ()
    {
        ...
        mIsTranslate = false;
        mTranslateValue = 0;
        mTranslateDuration = TRANSLATE_DEFAULT;
