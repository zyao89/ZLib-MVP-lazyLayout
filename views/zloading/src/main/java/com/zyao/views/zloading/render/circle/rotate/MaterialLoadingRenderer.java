package com.zyao.views.zloading.render.circle.rotate;
...
public class MaterialLoadingRenderer extends LoadingRenderer
{
    ...
    private void updateRingColor (float interpolatedTime)
    {
        ...
        {
            mCurrentColor = evaluateColorChange((interpolatedTime - COLOR_START_DELAY_OFFSET) / (1.0f - COLOR_START_DELAY_OFFSET), getStartingColor(), getNextColor());
        }
    }
