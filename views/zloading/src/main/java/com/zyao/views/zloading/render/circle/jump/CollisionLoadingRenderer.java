...
public class CollisionLoadingRenderer extends LoadingRenderer
{
    ...
    private static final int[] DEFAULT_COLORS = new int[]{Color.parseColor("#FF28435D"), Color.parseColor("#FFC32720")};
    ...
    protected void draw (Canvas canvas)
    {
             ...
             i++)
        {
            ...
            if (i == 0 && mStartXOffsetProgress != 0)
            {
                ...
                mOvalRect.set(mBallSideOffsets - mBallRadius - mBallRadius * leftStartProgress - xMoveOffset, mHeight - mOvalVerticalRadius - mOvalVerticalRadius * leftStartProgress, mBallSideOffsets - mBallRadius + mBallRadius * leftStartProgress - xMoveOffset, mHeight - mOvalVerticalRadius + mOvalVerticalRadius * leftStartProgress);
