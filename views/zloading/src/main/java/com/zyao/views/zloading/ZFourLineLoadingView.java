 ...
 * Author: Zyao89
 * Time: 2016/9/18 16:42
 */
public class ZFourLineLoadingView extends View
{
    private static final String TAG = "ZLoadingView";
    ...
    /** 默认起始旋转角度 */
    private static final int ROTATE_DEFAULT = 60;
    /** 默认动画执行时间 */
    private static final int DURATION_DEFAULT = 500;

    public ZFourLineLoadingView (Context context)
    {
        this(context, null);
    }

    public ZFourLineLoadingView (Context context, AttributeSet attrs)
    {
        this(context, attrs, 0);
    }

    public ZFourLineLoadingView (Context context, AttributeSet attrs, int defStyleAttr)
    {
    ...
    {
        ValueAnimator canvasRotateAnim = ValueAnimator.ofInt(ROTATE_DEFAULT + 0, ROTATE_DEFAULT + 360);
    ...
    private void startAnimTwo ()
    {
        ...
        canvasRotateAnim.setDuration(DURATION_DEFAULT);
        canvasRotateAnim.addUpdateListener(new ValueAnimator.AnimatorUpdateListener()
        {
            @Override
            public void onAnimationUpdate (ValueAnimator animation)
    ...
    private void startAnimThree ()
    {
        ...
        animatorSet.setDuration(DURATION_DEFAULT * 2);
        animatorSet.setInterpolator(new LinearInterpolator());
        animatorSet.addListener(new AnimatorListenerAdapter()
        {
            @Override
    ...
    private void startAnimFour ()
    {
        ...
        lineAnim.setDuration(DURATION_DEFAULT);
